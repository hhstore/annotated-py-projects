...
#
# 说明:
#   - 直接从 SimpleCookie 实现中截取, 此部分实现用了一些黑魔法
#
...
class CookieJar(dict):
    ...
    def __setitem__(self, key, value):
        ...
        if not cookie_header:
            cookie = Cookie(key, value)                  # cookie 创建
            cookie_header = MultiHeader("Set-Cookie")    # cookie 头
...
class Cookie(dict):
    ...
    def encode(self, encoding):
        ...
        return "; ".join(output).encode(encoding)    # 用;拼接, 并返回一个字符串
